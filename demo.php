...
<body>
    <h1>Youtube</h1>
    <img src="<?php echo $t->parse('http://youtu.be/fZ_JOBCLF-I')->imagePreview() ?>" />
    <?php echo $t->parse('http://youtu.be/fZ_JOBCLF-I')->render() ?>

    <h1>Dailymotion</h1>
    <img src="<?php echo $t->parse('http://www.dailymotion.com/video/xr9av5')->imagePreview() ?>" />
    <?php echo $t->parse('http://www.dailymotion.com/video/xr9av5')->render() ?>

    <h1>Vimeo</h1>
    <img src="<?php echo $t->parse('http://vimeo.com/15247292')->imagePreview() ?>" />
